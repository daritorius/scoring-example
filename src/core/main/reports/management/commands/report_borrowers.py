...
# from core.main.reports.services.ReportService import ReportService
# from core.profiles.services.ProfileService import ProfileService
from django.core.mail import EmailMessage
from django.core.management import BaseCommand
# from src.settings.apps_settings import DEFAULT_FROM_EMAIL, REPORTS_MANAGER
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        path_to_file = path_to_report + file_name
